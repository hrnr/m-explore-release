Name:           ros-jade-multirobot-map-merge
Version:        1.0.0
Release:        0%{?dist}
...
BuildRequires:  ros-jade-opencv3
...
%description
Merging multiple maps with knowledge of the initial relative positions of
robots.
